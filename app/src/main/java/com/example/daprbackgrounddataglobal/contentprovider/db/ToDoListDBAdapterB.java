package com.example.daprbackgrounddataglobal.contentprovider.db;
...
import com.example.daprbackgrounddataglobal.contentprovider.bean.ToDo;

import java.util.ArrayList;
import java.util.List;


public class ToDoListDBAdapterB {

    private static final String TAG= ToDoListDBAdapterB.class.getSimpleName();
    ...
    private static ToDoListDBAdapterB toDoListDBAdapterInstance;


    private ToDoListDBAdapterB(Context context){
        this.context=context;
        sqLliteDatabase=new ToDoListDBHelper(this.context,DB_NAME,null,DB_VERSION).getWritableDatabase();
    }

    public  static ToDoListDBAdapterB getToDoListDBAdapterInstance(Context context){
        if(toDoListDBAdapterInstance==null){
            toDoListDBAdapterInstance=new ToDoListDBAdapterB(context);
        }
