package com.example.daprbackgrounddataglobal.remotebind;
...
public class RemoteBindingProviderService extends Service {
// Need to Run RemoteBindService along with it
    private static final String TAG= RemoteBindingProviderService.class.getSimpleName();
