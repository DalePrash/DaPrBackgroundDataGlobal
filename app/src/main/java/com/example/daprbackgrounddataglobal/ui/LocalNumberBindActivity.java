...
import com.example.daprbackgrounddataglobal.localbindservice.NumberLocalBindService;

public class LocalNumberBindActivity extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = LocalNumberBindActivity.class.getSimpleName();
    ...
    private NumberLocalBindService myService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_number_local);
        ...
        serviceIntent=new Intent(getApplicationContext(), NumberLocalBindService.class);
        ...
        if(serviceConnection==null){
            serviceConnection=new ServiceConnection() {
                ...
                public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                    NumberLocalBindService.MyServiceBinder myServiceBinder=(NumberLocalBindService.MyServiceBinder)iBinder;
